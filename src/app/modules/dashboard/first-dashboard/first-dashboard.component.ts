...
export class FirstDashboardComponent {
  ...
  empresas: any = ["SEDUC","Projex Consulting","Cometais","Shopping Ponta Negra","Shopping Grande Circular"];
  ...
  dadosBarVOne: any = [{name: "SEDUC", y: 100000 , drilldown:"SEDUC"}, {name: "Projex Consulting", y: 150986,  drilldown:"Projex Consulting"}, {name: "Cometais", y: 198000,  drilldown: "Cometais"}, {name: "Shopping Ponta Negra", y: 98765 ,  drilldown: "Shopping Ponta Negra"},{name: "Shopping Grande Circular", y: 98655,  drilldown: "Shopping Grande Circular"}];


  firstName: string = "Receita Total";
  secondName: string = "Lucro Bruto";
  thirdName: string = "Lucro Líquido";
  fourthName: string = "Total de Despesas";
  fifthName: string = "Em Compras";
  firstValor: number = 57514.15;
  secondValor: number = 52847.99;
  ...
  fourthIcon: string = 'trending_down';
  fifthIcon: string = 'shopping_cart';
  alignL = "left"
  corrigirL = -110
  alignR = "right";
  corrigirR = 110

  dadosDoughnutOne: any = [{name: "SEDUC", y: 10000}, {name: "Projex Consulting", y: 15986}, {name: "Cometais", y: 198000}, {name: "Shopping Ponta Negra", y: 98765},{name: "Shopping Grande Circular", y: 98655}];
  dadosDoughnutTwo: any = [{name: "SEDUC", y: 1000}, {name: "Projex Consulting", y: 11986}, {name: "Cometais", y: 16700}, {name: "Shopping Ponta Negra", y: 23765},{name: "Shopping Grande Circular", y: 60655}];
